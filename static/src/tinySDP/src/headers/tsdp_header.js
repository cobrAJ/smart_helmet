...
if (!window.__b_release_mode) {
    tsdp_api_add_js_scripts('head',
        'static/src/tinySDP/src/headers/tsdp_header_A.js',
        'static/src/tinySDP/src/headers/tsdp_header_C.js',
        'static/src/tinySDP/src/headers/tsdp_header_M.js',
        'static/src/tinySDP/src/headers/tsdp_header_O.js',
        'static/src/tinySDP/src/headers/tsdp_header_Str.js', // B, E, I, K, P, R, S, T, U, Z
        'static/src/tinySDP/src/headers/tsdp_header_V.js'
    );
}