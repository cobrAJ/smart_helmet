...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        'static/src/tinySIP/src/api/tsip_api_common.js',
        'static/src/tinySIP/src/api/tsip_api_info.js',
        'static/src/tinySIP/src/api/tsip_api_invite.js',
        'static/src/tinySIP/src/api/tsip_api_message.js',
        'static/src/tinySIP/src/api/tsip_api_options.js',
        'static/src/tinySIP/src/api/tsip_api_publish.js',
        'static/src/tinySIP/src/api/tsip_api_register.js',
        'static/src/tinySIP/src/api/tsip_api_subscribe.js'
    );
}