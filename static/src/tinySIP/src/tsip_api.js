...
// add tinySAK API
tsip_api_add_js_scripts('head', 'static/src/tinySAK/src/tsk_api.js');

// add tinyMEDIA API
tsip_api_add_js_scripts('head', 'static/src/tinyMEDIA/src/tmedia_api.js');

// add tinySDP API
tsip_api_add_js_scripts('head', 'static/src/tinySDP/src/tsdp_api.js');

// add tinySIP API
tsip_api_add_js_scripts('head',
    'static/src/tinySIP/src/tsip_action.js',
    'static/src/tinySIP/src/tsip_event.js',
    'static/src/tinySIP/src/tsip_message.js',
    'static/src/tinySIP/src/tsip_session.js',
    'static/src/tinySIP/src/tsip_stack.js',
    'static/src/tinySIP/src/tsip_timers.js',
    'static/src/tinySIP/src/tsip_uri.js'
);
...
tsip_api_add_js_scripts('head',
    'static/src/tinySIP/src/authentication/tsip_auth.js',
    'static/src/tinySIP/src/authentication/tsip_challenge.js'
);

tsip_api_add_js_scripts('head',
    'static/src/tinySIP/src/dialogs/tsip_dialog.js',
    ...
    'static/src/tinySIP/src/dialogs/tsip_dialog_layer.js'
...
tsip_api_add_js_scripts('head',
    'static/src/tinySIP/src/headers/tsip_header.js'
...
tsip_api_add_js_scripts('head',
    'static/src/tinySIP/src/parsers/tsip_parser_header.js'
...
tsip_api_add_js_scripts('head',
    'static/src/tinySIP/src/transactions/tsip_transac.js'
...
tsip_api_add_js_scripts('head',
    'static/src/tinySIP/src/transports/tsip_transport.js',
    'static/src/tinySIP/src/transports/tsip_transport_layer.js'
);