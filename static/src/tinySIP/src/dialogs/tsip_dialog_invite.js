...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        'static/src/tinySIP/src/dialogs/tsip_dialog_invite__client.js',
        'static/src/tinySIP/src/dialogs/tsip_dialog_invite__ect.js',
        'static/src/tinySIP/src/dialogs/tsip_dialog_invite__hold.js',
        'static/src/tinySIP/src/dialogs/tsip_dialog_invite__server.js',
        'static/src/tinySIP/src/dialogs/tsip_dialog_invite__timers.js'
    );
}
