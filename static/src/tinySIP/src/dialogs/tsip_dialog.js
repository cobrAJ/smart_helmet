...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        'static/src/tinySIP/src/dialogs/tsip_dialog_generic.js',
        'static/src/tinySIP/src/dialogs/tsip_dialog_invite.js',
        'static/src/tinySIP/src/dialogs/tsip_dialog_register.js'
    );
}
