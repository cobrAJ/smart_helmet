...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        'static/src/tinySIP/src/transactions/tsip_transac_ict.js',
        'static/src/tinySIP/src/transactions/tsip_transac_ist.js',
        'static/src/tinySIP/src/transactions/tsip_transac_layer.js',
        'static/src/tinySIP/src/transactions/tsip_transac_nict.js',
        'static/src/tinySIP/src/transactions/tsip_transac_nist.js'
    );
}
